            ...
            <div className="about-link-grid" style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center', width: '100%' }}>
              ...
              <div id="who-i-am" className="about-link-info" style={{
                ...
                <p style={{ fontSize: '1rem', color: SLATE.accent, lineHeight: 1.75, maxWidth: '600px', margin: '0 0 2.5rem' }}>
                  <span style={{ color: SLATE.dark, fontWeight: 600 }}>Senior Product Marketing & GTM Manager</span> with 7 years of experience bringing B2B and B2C products to life at high-growth companies — from BlaBlaCar and Doctolib to PayFit.
                  <br /><br />
                  I started in marketing, moved into CRM, then transitioned into product marketing. That journey gave me a full-funnel perspective: I think about GTM through the lens of <span style={{ color: SLATE.dark, fontWeight: 600 }}>customer behavior, willingness to pay, and long-term adoption</span>.
                </p>
